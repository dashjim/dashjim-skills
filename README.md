...
│   ├── shanghai-2025-yuwen-yimo/    # 2025届 一模（15份-原卷.md带官方评分说明）
│   ├── shanghai-2025-yuwen-ermo/    # 2025届 二模（12份-原卷.md）
│   ├── shanghai-2026-yuwen-yimo/    # 2026届 一模（15份-原卷.md）
│   ├── shanghai-2026-yuwen-ermo/    # 2026届 二模（12份-原卷.md）
│   └── 原卷抓取状态台账.md          # 各卷原卷抓取状态与失败原因记录
└── research/
...
- `exam-corpus/` — 上海 16 区 2024–2026 届高三语文一模/二模阅读题。其中 `-原卷.md` 为**题目原文 + 官方完整答案（含评分说明，逐字照录）**，`-阅读.md` 为答案要点精简版。原卷已扩充至 **54 份**（2025一模15 / 2025二模12 / 2026一模15 / 2026二模12），均来自 21世纪教育网可免费查看全文的高三含答案详情页；哪些区已抓、哪些区无免费全文源，见 `exam-corpus/原卷抓取状态台账.md`。
- `research/语文主观题研究/` — 最初以 18 份含官方评分说明的原卷为实证，反推出**分文体（论述/文学/诗歌/文言记叙/文言论说）的答题模板库**，即 `chinese-subjective-coach` 的知识来源。研究方法与关键决策见该目录下 `CLAUDE.md`。（原卷实证基础后续已扩充至 54 份。）
